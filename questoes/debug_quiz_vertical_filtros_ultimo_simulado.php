...
echo "<h1>DEBUG QUIZ VERTICAL FILTROS ÚLTIMO SIMULADO</h1>";
...
try {
    ...
    // Verificar se o problema está na exibição real
    echo "<h3>4. Verificando se o problema está na exibição real:</h3>";
...
echo "<p>1. Se o embaralhamento está funcionando, o problema pode estar na exibição real</p>";
